...
public class SlotOutputIngotEnchanter extends Slot {
	
	/** The player that is using the GUI where this slot resides. */
    private final EntityPlayer thePlayer;
    private int numGrinderOutput;

    public SlotOutputIngotEnchanter(EntityPlayer parPlayer, 
    ...
    protected void onCrafting(ItemStack parItemStack)
    {
        if (!thePlayer.worldObj.isRemote)
        {
            ...
            float expFactor = RecipesIngotEnchanter.instance()
                  .getEnchantingExperience(parItemStack);
